  ...
  const people = [
    {
      ...
      role: "Secretary",
      picture:
        "https://suvidhafoundationedutech.org/img/team/Shobha_Motghare.jpeg",
      description:
    ...
    },
    {
      ...
      lastname: "Badhe",
      role: "President",
      picture: "https://suvidhafoundationedutech.org/img/team/Payal_Badhe.jpg",
      description:
        "Harum iusto exercitationem assumenda quas nostrum perspiciatis quos iste sit reprehenderit, libero quae aperiam sapiente delectus, porro tempore minus repellendus ratione distinctio!",
      facebookURL: "#link",
      twitterURL: "#link",
    ...
    },
    {
      ...
      lastname: "Shendre",
      role: "Treasurer",
      picture: "https://suvidhafoundationedutech.org/img/Bharti_Shendre.jpg",
      description:
        "Harum iusto exercitationem assumenda quas nostrum perspiciatis quos iste sit reprehenderit, libero quae aperiam sapiente delectus, porro tempore minus repellendus ratione distinctio!",
      facebookURL: "#link",
      twitterURL: "#link",
    ...
    },
    {
      ...
      lastname: "Kalambe",
      role: "Advisor",
      picture: "https://suvidhafoundationedutech.org/img/Nilima_Kalambe.jpg",
      description:
        "Harum iusto exercitationem assumenda quas nostrum perspiciatis quos iste sit reprehenderit, libero quae aperiam sapiente delectus, porro tempore minus repellendus ratione distinctio!",
      facebookURL: "#link",
      twitterURL: "#link",
      ...
      <div className="relative  w-full text-gray-700">
        ...
        <div className="mb-10 flex justify-center items-center flex-col">
          <div className="mb-3 flex justify-center items-center ">
            <h2 className="px-3 uppercase lg:text-lg md:text-lg text-center font-bold text-[#FAB40C]">
              Our passionate team
            </h2>
          </div>
          <p className="lg:text-3xl md:text-2xl text-xl text-center font-semibold ">
        ...
        <div className="mx-auto px-4 w-full max-w-5xl grid grid-cols-2 gap-y-4 sm:gap-y-10">
          ...
          <div className="col-span-full lg:col-span-1 flex flex-col sm:flex-row justify-center items-center">
            {/* ::Team members */}
            <ul className="mb-4 sm:mb-0 px-4 flex flex-wrap gap-2 sm:flex-col justify-center items-center space-x-3 sm:space-x-0 sm:space-y-3">
          ...
          <div className="col-span-full lg:col-span-1 mx-auto lg:mx-0 max-w-lg flex flex-col justify-center space-y-4">
            {/* ::Role */}
            <span className="font-bold uppercase tracking-wider text-[#FAB40C]">
              {people[member].role}
            </span>
            {/* ::Name */}
